...
; Align 'case' and 'default' statements directly under 'switch'
; (switch_statement
;   body: (compound_statement) @indent.zero)
; Align compound_statement inside switch_statement with the switch itself
((switch_statement
   body: (compound_statement) @indent.dedent))
